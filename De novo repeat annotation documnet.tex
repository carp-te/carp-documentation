...
To build krishna and krishna-matrix, go to the directory that contains krishna related codes {\color{red}{(As I made a directory "Workspace" when installing go, so codes download from github will automatically saved under /Workspace/src. If you saved in your \texttt{\$}HOME directory, just go to the \texttt{\$}HOME/src where you saved all Biogo package)}}.
